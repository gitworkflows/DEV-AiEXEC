...
1. Prepare a Render instance that can support Aiexec.

   Aiexec requires at least 2 GB of RAM to run, so you must use a Render instance type of **Standard** or better.
...
2. Follow this link to start a Aiexec deployment on Render:
...
When deployment is complete, your Aiexec instance is ready to use.