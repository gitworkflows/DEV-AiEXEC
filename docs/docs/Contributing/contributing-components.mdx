...
class DataFrameProcessor(Component):
    ...
    documentation: str = "https://docs.khulnasoft.com/components-dataframe-processor"
...
8. Submit documentation for your component. For this example component, you would submit documentation to the [Data components page](https://github.com/khulnasoft-lab/aiexec/blob/main/docs/docs/Components/components-data.mdx).
