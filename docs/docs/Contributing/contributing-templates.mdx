...
For template formatting examples, see [`/starter_projects`](https://github.com/khulnasoft-lab/aiexec/tree/main/src/backend/base/aiexec/initial_setup/starter_projects) in the Aiexec repository.
...
4. Create a Pull Request (PR) from your fork to the main Aiexec repository.
5. Include a screenshot of your template in the PR.

The Aiexec team will review your PR, offer feedback, and, if approved, merge the template.
