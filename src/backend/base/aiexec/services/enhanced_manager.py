"""Enhanced ServiceManager that extends lfx's ServiceManager with aiexec features."""
...
class ServiceManager(BaseServiceManager):
    """Enhanced ServiceManager with aiexec factory system and dependency injection."""
    ...
    def get_factories(cls) -> list[ServiceFactory]:
        ...
        base_module = "aiexec.services"
        factories = []

        for name in service_names:
            try:
                base_module = "lfx.services" if name == "settings" else "aiexec.services"
