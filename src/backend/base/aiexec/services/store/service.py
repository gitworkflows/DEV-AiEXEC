...
from aiexec.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from aiexec.services.store.schema import (
...
from aiexec.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.aiexec.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates aiexec with the store which is a Directus instance.
