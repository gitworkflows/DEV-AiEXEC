...
if TYPE_CHECKING:
    ...
    from aiexec.services.state.service import StateService
    ...
    from aiexec.services.variable.service import VariableService
...
def get_service(service_type: ServiceType, default=None):
    ...
    if not service_manager.are_factories_registered():
        ...
        from aiexec.services.manager import ServiceManager
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from aiexec.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from aiexec.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from aiexec.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from aiexec.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from aiexec.services.variable.factory import VariableServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from aiexec.services.database.factory import DatabaseServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from aiexec.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from aiexec.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from aiexec.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from aiexec.services.job_queue.factory import JobQueueServiceFactory
