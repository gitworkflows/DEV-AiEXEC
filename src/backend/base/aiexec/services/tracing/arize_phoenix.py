...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("aiexec.project.name", self.project_name)
            self.root_span.set_attribute("aiexec.flow.name", self.flow_name)
            self.root_span.set_attribute("aiexec.flow.id", self.flow_id)
