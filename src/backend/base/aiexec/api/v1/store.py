...
from aiexec.api.utils import CurrentActiveUser, check_aiexec_version
from aiexec.services.auth import utils as auth_utils
from aiexec.services.deps import get_settings_service, get_store_service
from aiexec.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_aiexec_version(component)
