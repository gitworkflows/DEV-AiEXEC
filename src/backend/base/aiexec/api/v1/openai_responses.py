...
from aiexec.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
...
from aiexec.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from aiexec.schema.content_types import ToolContent
from aiexec.services.auth.utils import api_key_security
from aiexec.services.database.models.flow.model import FlowRead
from aiexec.services.database.models.user.model import UserRead
from aiexec.services.deps import get_telemetry_service
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Aiexec events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Aiexec flow.
    ...
    # Extract global variables from X-AIEXEC-GLOBAL-VAR-* headers
    variables = {}
    header_prefix = "x-aiexec-global-var-"
