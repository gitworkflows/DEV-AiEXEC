...
from aiexec.api.utils import CurrentActiveMCPUser
from aiexec.api.v1.mcp_utils import (
    current_user_ctx,
    handle_call_tool,
...
from aiexec.services.auth.mcp_encryption import decrypt_auth_settings, encrypt_auth_settings
from aiexec.services.database.models import Flow, Folder
from aiexec.services.database.models.api_key.crud import check_key, create_api_key
from aiexec.services.database.models.api_key.model import ApiKeyCreate
...
async def verify_project_auth_conditional(
    ...
    async with session_scope() as session:
        ...
        from aiexec.services.auth.utils import get_current_user_mcp
    ...
    try:
        async with session_scope() as session:
            ...
            if project.auth_settings:
                from aiexec.api.v1.schemas import AuthSettings
...
class ProjectMCPServer:
    def __init__(self, project_id: UUID):
        ...
        self.server = Server(f"aiexec-mcp-project-{project_id}")
