...
from aiexec.services.database.models.message.model import MessageRead, MessageTable
...
async def aadd_messages(messages: Message | list[Message], flow_id: str | UUID | None = None):
    ...
    # Check if all messages are Message instances (either from aiexec or lfx)
    for message in messages:
        # Accept Message instances from both aiexec and lfx packages
